 ...
 * Description: Gravity Forms donation, cart, Stripe payment and configurable CRM transaction orchestration.
 * Version: 0.9.0
...
define('WFCC_VERSION', '0.9.0');
define('WFCC_SCHEMA_VERSION', '9');
...
require_once WFCC_PLUGIN_DIR . 'functions/crm.php';
...
require_once WFCC_PLUGIN_DIR . 'functions/release-governance.php';
